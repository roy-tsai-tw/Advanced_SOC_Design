...
architecture behav of userdma is 
    ...
    "userdma_userdma,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=4188,HLS_SYN_LUT=8113,HLS_VERSION=2022_1}";
    ...
    port (
        ...
        incount47_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        incount47_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    ...
    port (
        ...
        outcount48_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        outcount48_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
